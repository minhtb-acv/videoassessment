...
$PAGE->set_url('/mod/videoassessment/assignclass/autogroup.php', array('courseid' => $courseid));
...
$returnurl = $CFG->wwwroot.'/mod/videoassessment/assignclass/index.php?id='.$course->id;
