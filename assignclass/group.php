...
if ($id !== 0) {
    $PAGE->set_url('/mod/videoassessment/assignclass/group.php', array('id'=>$id));
} else {
    $PAGE->set_url('/mod/videoassessment/assignclass/group.php', array('courseid'=>$courseid));
}
...
navigation_node::override_active_url(new moodle_url('/mod/videoassessment/assignclass/index.php', array('id' => $course->id)));

$returnurl = $CFG->wwwroot.'/mod/videoassessment/assignclass/index.php?id='.$course->id.'&group='.$id;
...
$PAGE->navbar->add($strgroups, new moodle_url('/mod/videoassessment/assignclass/index.php', array('id'=>$courseid)));
