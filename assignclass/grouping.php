...
$url = new moodle_url('/mod/videoassessment/assignclass/grouping.php');
if ($id) {
    $url->param('id', $id);
...
$returnurl = $CFG->wwwroot.'/mod/videoassessment/assignclass/groupings.php?id='.$course->id;
...
$PAGE->navbar->add($strgroupings, new moodle_url('/mod/videoassessment/assignclass/groupings.php', array('id'=>$courseid)));
