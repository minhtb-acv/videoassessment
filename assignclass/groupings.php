...
require_once $CFG->dirroot.'/mod/videoassessment/assignclass/lib.php';

$courseid = required_param('id', PARAM_INT);

$PAGE->set_url('/mod/videoassessment/assignclass/groupings.php', array('id'=>$courseid));
...
navigation_node::override_active_url(new moodle_url('/mod/videoassessment/assignclass/index.php', array('id'=>$courseid)));
...
if ($groupings = $DB->get_records('groupings', array('courseid'=>$course->id), 'name')) {
    ...
    foreach($groupings as $grouping) {
        ...
        $url = new moodle_url('/mod/videoassessment/assignclass/grouping.php', array('id' => $grouping->id));
        ...
        if (empty($grouping->idnumber) || $canchangeidnumber) {
            ...
            $url = new moodle_url('/mod/videoassessment/assignclass/grouping.php', array('id' => $grouping->id, 'delete' => 1));
        ...
        $url = new moodle_url('/mod/videoassessment/assignclass/assign.php', array('id' => $grouping->id));
