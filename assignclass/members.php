...
$PAGE->set_url('/mod/videoassessment/assignclass/members.php', array('group'=>$groupid));
...
$returnurl = $CFG->wwwroot.'/mod/videoassessment/assignclass/index.php?id='.$course->id.'&group='.$group->id;
...
$PAGE->navbar->add($strgroups, new moodle_url('/mod/videoassessment/assignclass/index.php', array('id'=>$course->id)));
...
<div id="addmembersform">
    <form id="assignform" method="post" action="<?php echo $CFG->wwwroot; ?>/mod/videoassessment/assignclass/members.php?group=<?php echo $groupid; ?>">
    <div>
