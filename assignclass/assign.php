...
$PAGE->set_url('/mod/videoassessment/assignclass/assign.php', array('id'=>$groupingid));
...
$returnurl = $CFG->wwwroot.'/mod/videoassessment/assignclass/groupings.php?id='.$courseid;
