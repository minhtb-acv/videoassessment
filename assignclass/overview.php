...
$rooturl   = $CFG->wwwroot.'/mod/videoassessment/assignclass/overview.php?id='.$courseid;

if (!$course = $DB->get_record('course', array('id'=>$courseid))) {
    print_error('invalidcourse');
}

$url = new moodle_url('/mod/videoassessment/assignclass/overview.php', array('id'=>$courseid));
if ($groupid !== 0) {
